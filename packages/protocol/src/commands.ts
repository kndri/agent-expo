...
export type LaunchCommandType = z.infer<typeof LaunchCommand>;
export type TerminateCommandType = z.infer<typeof TerminateCommand>;
export type ReinstallCommandType = z.infer<typeof ReinstallCommand>;
export type SnapshotCommandType = z.infer<typeof SnapshotCommand>;
export type TapCommandType = z.infer<typeof TapCommand>;
export type DoubleTapCommandType = z.infer<typeof DoubleTapCommand>;
export type LongPressCommandType = z.infer<typeof LongPressCommand>;
export type FillCommandType = z.infer<typeof FillCommand>;
export type ClearCommandType = z.infer<typeof ClearCommand>;
export type TypeCommandType = z.infer<typeof TypeCommand>;
export type ScrollCommandType = z.infer<typeof ScrollCommand>;
export type SwipeCommandType = z.infer<typeof SwipeCommand>;
export type PinchCommandType = z.infer<typeof PinchCommand>;
export type NavigateCommandType = z.infer<typeof NavigateCommand>;
export type BackCommandType = z.infer<typeof BackCommand>;
export type HomeCommandType = z.infer<typeof HomeCommand>;
export type ReloadCommandType = z.infer<typeof ReloadCommand>;
export type ShakeCommandType = z.infer<typeof ShakeCommand>;
export type ScreenshotCommandType = z.infer<typeof ScreenshotCommand>;
export type VisualCompareCommandType = z.infer<typeof VisualCompareCommand>;
export type ScreenshotSaveCommandType = z.infer<typeof ScreenshotSaveCommand>;
export type ScreenshotCompareCommandType = z.infer<typeof ScreenshotCompareCommand>;
export type ScreenshotDiffCommandType = z.infer<typeof ScreenshotDiffCommand>;
export type ScreenshotListCommandType = z.infer<typeof ScreenshotListCommand>;
export type ScreenshotDeleteCommandType = z.infer<typeof ScreenshotDeleteCommand>;
export type AssertCommandType = z.infer<typeof AssertCommand>;
export type WaitForCommandType = z.infer<typeof WaitForCommand>;
export type NetworkRequestsCommandType = z.infer<typeof NetworkRequestsCommand>;
export type NetworkMockCommandType = z.infer<typeof NetworkMockCommand>;
export type NetworkClearMocksCommandType = z.infer<typeof NetworkClearMocksCommand>;
export type SupabaseCallsCommandType = z.infer<typeof SupabaseCallsCommand>;
export type SupabaseClearCommandType = z.infer<typeof SupabaseClearCommand>;
export type ConvexCallsCommandType = z.infer<typeof ConvexCallsCommand>;
export type ConvexClearCommandType = z.infer<typeof ConvexClearCommand>;
export type DeviceListCommandType = z.infer<typeof DeviceListCommand>;
export type DeviceInfoCommandType = z.infer<typeof DeviceInfoCommand>;
export type SetLocationCommandType = z.infer<typeof SetLocationCommand>;
export type SetPermissionCommandType = z.infer<typeof SetPermissionCommand>;
export type KeyboardCommandType = z.infer<typeof KeyboardCommand>;
